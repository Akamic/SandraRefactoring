...
public class Client {
	...
	/*
	 * public String informe() { String resultat =
	 * "Informe de lloguers del client " + getNom() + " (" + getNif() + ")\n";
	 * for (Lloguer lloguer : lloguers) { // composa els resultats d'aquest
	 * lloguer resultat += "\t" + lloguer.getVehicle().getMarca() + " " +
	 * lloguer.getVehicle().getModel() + ": " + (lloguer.quantitat() * 30) + "€"
	 * + "\n"; }
	 * 
	 * // afegeix informació final resultat += "Import a pagar: " +
